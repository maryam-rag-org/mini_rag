...
@celery_app.task(
                 bind=True, name="tasks.file_processing.process_project_file",
...
def process_project_file(self, project_id: int, 
    ...
    return asyncio.run(
        _process_project_file(self, project_id, file_id, chunk_size,
...
async def _process_project_file(task_instance, project_id: int, 
    ...
    try:
        ...
        task_name = "tasks.file_processing.process_project_file"
